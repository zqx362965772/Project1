        ...
        <View style={this.publishViewStyles.header}>
          <Image
            ...
            source={{
                            ...
                            uri:'http://112.126.77.216/ZQX_DO_NOT_TOUCH/background2.jpg'
                        }}>
          </Image>
        </View>
        <View>
...
var PublishForm2 = React.createClass({
  ...
  handleAdd: function () {
    if (Platform.OS === 'ios') {
      ...
      this.promptResponse(this.state.androidCityText);
    }
  },
  ...
  renderText(){
    if(Platform.OS!='ios'){
      return <TextInput onChangeText={this.handleCityInput}></TextInput>
    }
  },
  handleCityInput(text){
    this.setState({
      androidCityText:text
    });
  },
  render: function () {
