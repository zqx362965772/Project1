...
var USER_Login = "http://112.126.77.216/gaodezijiayou/login.action"
...
var LoginForm = React.createClass({
  ...
  handleSubmit: function () {
    //1.提交服务器
    fetch(USER_Login + '?username=' + this.state.userName + '&password=' + this.state.password).then(res=>res.json())
      .then(resp=>{
  ...
  render: function () {
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity handleClick={this.handleRedirect}
                          style={[styles.mt30,{justifyContent:'center',alignItems:'center'}]}>
